...
import icon from "../../assets/images/logo_header.png";
const Footer = () => {
  return (
    <footer className="p-4 bg-[#393E46] sm:p-6 text-white">
      <div className="md:flex md:justify-between flex justify-center">
        <div>
          <a href="/" className="flex items-center">
            <img src={icon} className="mr-3 h-8" alt="KDShop Logo" />
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a
            href="https://www.facebook.com/tranhakhanhduy/"
