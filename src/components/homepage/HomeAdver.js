  ...
  return (
    <div className="home-adver bg-white h-[350px] flex items-center justify-around res600:h-[720px] res600:flex-col">
      ...
      <div className="res600:flex res600:justify-center">
        ...
        <h2 className="font-bold font-mada text-[38px] md:text-[30px] res600:self-center">Look For Models Now</h2>
      </div>
        ...
        <div className="res600:flex res600:justify-center"> 
        <button className="res600:self-center res600:mx-auto shadow-lg bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white text-center px-8 py-3 rounded-xl">
          Shop Now
        </button>
        </div>
      </div>
